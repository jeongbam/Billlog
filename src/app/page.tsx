  ...
  return (
    <div className="min-h-screen bg-[#E7ECF3] flex justify-center">
      <div className="w-full max-w-md bg-white min-h-screen flex flex-col justify-between px-6 pt-16 pb-9 shadow-xl">
        <div>
          <div className="text-[16px] font-bold text-mint-500 tracking-wide">
            BILLLOG
          </div>
          <h1 className="text-[28px] font-bold leading-[1.35] mt-4">
            모임을 기록하는
            <br />
            가장 쉬운 방법
          </h1>
          ...
          <div className="mt-20 flex justify-center">
            <div className="w-56 h-56 rounded-[28px] bg-mint-50 flex items-center justify-center">
              <div className="w-40 h-28 bg-white rounded-2xl shadow-[0_10px_30px_rgba(16,104,193,0.14)] flex flex-col p-3.5 gap-1.5">
                ...
                <div className="mt-auto flex justify-between items-center">
                  ...
                  <div className="text-[10px] font-bold text-mint-500">
                    158,000원
                  </div>
                </div>
              </div>
        ...
        <div>
          ...
          <div className="text-center text-[12px] mt-3.5">
